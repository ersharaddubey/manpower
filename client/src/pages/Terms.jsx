      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-gray-400 leading-relaxed font-medium">
          <section className="border-l-4 border-orange-600 pl-8">
            ...
            <p>By accessing workfource Solutions, you agree to be bound by these Terms of Service. If you do not agree, please refrain from using our industrial recruitment platform.</p>
          </section>
          ...
          <section className="border-l-4 border-white/10 pl-8">
            ...
            <p>workfource Solutions is a facilitator of manpower. While we verify technical standards, final hiring decisions and workplace safety remain the responsibility of the client and candidate.</p>
          </section>
        </div>
      </div>
    </div>
