      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12 text-gray-600 leading-relaxed font-medium">
          <section>
            ...
            <p>At Rhodeotech Solutions, we collect personal information such as names, email addresses, and professional backgrounds solely for the purpose of technical recruitment and industrial manpower sourcing. This data is handled with the highest level of encryption.</p>
          </section>
